      ...
      {isOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6">
          ...
          <motion.div
            ...
            className="relative w-full max-w-[92%] sm:max-w-lg max-h-[90vh] overflow-y-auto no-scrollbar rounded-3xl border border-white/10 bg-[#0c0824]/98 p-5 sm:p-8 shadow-[0_0_50px_rgba(234,179,8,0.15)]"
          >
